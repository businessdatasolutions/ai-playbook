    ...
    document.addEventListener('DOMContentLoaded', function () {
        const data = [
            ...
            },
            {
                ...
                type: "reading",
                imageUrl: "../docs/LandingAI_Transformation_Playbook_11-19.png",
                readUrl: "../docs/LandingAI_Transformation_Playbook_11-19.pdf"
            },
        ...
        data.forEach(item => {
            ...
            if (item.type === 'video') {
                cardContent = `
                    <iframe src="${item.url}" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen class="card-img-top"></iframe>
                `;
            } else { // 'reading'
                cardContent = `
